...
import hu.asztrikx.workout.presentation.ui.logEdit.LogEditEvent
import hu.asztrikx.workout.presentation.ui.logEdit.LogEditUIEvent
...
fun LogEditScreen(
	...
	BetterScaffold(
		...
		Column(
			...
			LazyColumn {
				items(log.quantities, key = { it.category.id }) { quantity ->
					LogEditQuantityItem(quantity, { viewModel.onEvent(LogEditEvent.Category(it, quantity.category.id)) })
				}
			}
		}
	}
